...
class Profile extends Model
{
    ...
    */
    ...
    {
        return $this->belongsToMany('App\Models\Icon', 'profile_icon');
    }

    //Avatar Image upload
    public function setAvatarImageAttribute($value)
    {
        $attribute_name = "avatar_image";
        $disk = config('backpack.base.root_disk_name'); // or use your own disk, defined in config/filesystems.php
        $destination_path = "public/uploads/profile"; // path relative to the disk above
